        ...
        function (G, $rootScope, $timeout) {
          return {
            ...
            link: function ($scope, $element, $attrs, ngModel) {
              ...
              var initYear = Array.apply(null, Array(12)).map(function (
                item,
                i
              ) {
                return i - 1;
              ...
              function setDateView(date) {
                ...
                var dateView = [];
                var startDate = moment(date).date(1).weekday(0);
                ...
                if ($scope.minDateArr.year, $scope.minDateArr.month, $scope.minDateArr.date) {
                  ...
                  ]).valueOf() < moment(date).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf();
                } else {
                ...
                if ($scope.maxDateArr.year && $scope.maxDateArr.month && $scope.maxDateArr.date) {
                  ...
                  ]).valueOf() > moment(date).add(1, 'month').date(1).hour(0).minute(0).second(0).millisecond(0).valueOf();
                } else {
                ...
                if ($scope.minDateArr.year, $scope.minDateArr.month, $scope.minDateArr.date) {
                  dateView.prevYear = moment([
                    ...
                    $scope.minDateArr.month - 1,
                    $scope.minDateArr.date,
                  ]).valueOf() < moment(date).add(-1, 'year').hour(0).minute(0).second(0).millisecond(0).valueOf();
                } else {
                ...
                for (var i = 0; i < 42; i++) {
                  var nowDate = startDate.clone().add(i, 'day').hour(0).minute(0).second(0).millisecond(0);
                  var tag = 'now';
                  if (
                    nowDate.valueOf() < moment(date).date(1).hour(0).minute(0).second(0).millisecond(0).valueOf()
                  ) {
                    tag = 'old';
                  }
                  if (
                  ...
                  if (
                    nowDate.valueOf() ===
                    moment().hour(0).minute(0).second(0).millisecond(0).valueOf()
                  ) {
                    tag = 'today';
                  }
                  if (!$scope.dateRange) {
                    if (
                      nowDate.valueOf() ===
                      moment([$scope.dateData.year, $scope.dateData.month - 1, $scope.dateData.date, ]).hour(0).minute(0).second(0).millisecond(0).valueOf()
                    ) {
                      tag = 'active';
                    }
                  } else {
                    if ($scope.dateRangeData&&(
                      ($scope.dateRangeData.start &&(tag==='now'||tag ==='today') &&(nowDate.valueOf() ===
                        $scope.dateRangeData.start.hour(0).minute(0).second(0).millisecond(0).valueOf())) ||
                      ($scope.dateRangeData.end  &&(tag==='now'||tag ==='today')&& (nowDate.valueOf() ===
                        $scope.dateRangeData.end.hour(0).minute(0).second(0).millisecond(0).valueOf())))) {
                      tag = 'hover';
                    }
                  }
                  if ($scope.dateRange&&$scope.tmpDate&&(tag==='now'||tag ==='today')) {
                    if (
                      nowDate.valueOf() ===
                      $scope.tmpDate.hour(0).minute(0).second(0).millisecond(0).valueOf()
                    ) {
                      tag = 'hover';
                    }
                  }
              ...
              function setMonthView() {
                ...
                $scope.monthView = Array.apply(null, Array(12)).map(function (
                  item,
                  i
                ) {
                  var thisMonth = i + 1;
              ...
              $scope.setMonth = function (month) {
                if (!month.disabled) {
                  ...
                  setMonthView();
                  setDateView(
                    moment([$scope.dateData.year, $scope.dateData.month - 1])
                  );
              ...
              $scope.setPreYear = function (type) {
                ...
                setMonthView();
                setDateView(
                  moment([$scope.dateData.year, $scope.dateData.month - 1, 1])
                );
              ...
              function setYearView(year) {
                ...
                $scope.yearView = initYear.map(function (data, index) {
              ...
              function setHourView() {
                ...
                $scope.hourView = Array.apply(null, Array(24)).map(function (
                  item,
                  i
                ) {
                  return {
              ...
              function setMinView() {
                ...
                $scope.minView = Array.apply(null, Array(60)).map(function (
                  item,
                  i
                ) {
                  return {
              ...
              function setSecondView() {
                ...
                $scope.secondView = Array.apply(null, Array(60)).map(function (
                  item,
                  i
                ) {
                  return {
