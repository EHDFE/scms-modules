 ...
 * @author 程
 * @lastBy
 * @htmlUrl scmsModules/cardList/tableHtml.html
 */
    ...
    function($cookies, $http, allRouterData, $rootScope, $state, $timeout) {
      return {
        ...
        link: function ($scope, $element, $attrs) {
          ...
          $scope.hidePageSize = $attrs.hidePageSize || true;
          $scope.currPage = $scope.currPage || 1;
          //$scope.fetchParam = $scope.fetchParam || {};
          $scope.items = [];
          $scope.pageSize =
            $scope.pageSize || parseInt($cookies.pageSize, 10) || 12;
