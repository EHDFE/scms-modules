...
export default (app, elem, attrs, scope) => {
  app.directive("ngTableFixed", [
    ...
    "$timeout",
    "$rootScope",
    function($state, $compile, $timeout, $rootScope) {
      ...
      TableFixed.prototype = {
        ...
        setHeaderScrollLeft: function($parentEl, scrollEl) {
          $parentEl
            .find(".fix-top")
            .css({ "margin-left": -scrollEl.scrollLeft + "px" });
        },
        ...
        getScrollWidth: function() {
          return this.$tableBox && this.$tableBox[0]
            ? this.$tableBox[0].offsetWidth - this.$tableBox[0].clientWidth
            : 0;
        },
        ...
        getScrollHeight: function() {
          return this.$tableBox && this.$tableBox[0]
            ? this.$tableBox[0].offsetHeight - this.$tableBox[0].clientHeight
            : 0;
        },
        ...
        bindEvent: function() {
          ...
          this.$parentEl.delegate("tbody tr", "mouseenter", function(event) {
            ...
            $currentHoverIndex = _this.$parentEl.find(
              '[current-index="' + index + '"]'
            );
        ...
        setBoxHeight: function() {
          ...
          if (
            this.$tableBox[0] &&
            this.$tableBox[0].scrollHeight > height &&
            this.config.header
          ) {
            this.$parentEl.addClass("fixed-table-overflow-y");
            this.$tableBox.css({ height: height + "px" });
            this.$fixedColBox.css({
              height: height - this.getScrollHeight() + "px"
            });
          } else {
        ...
        setThWidth: function(isUpdate, $scope) {
          ...
          this.thwidthTimeout = $timeout(function() {
            ...
            _this.$parentEl
              .find(".fixed-header-box table")
              .width(_this.$tableBox[0].scrollWidth - 1 + scrollWidth);
            ...
            $tableFirstRow.each(function(index, el) {
              ...
              if (index >= tableFirstRowLength - rightTableFirstRowLength) {
                ...
                $rightTableFirstRow
                  .eq(index - (tableFirstRowLength - rightTableFirstRowLength))
                  .css("width", width + "px");
              }
            ...
            _this.$fixedHeaderBox
              .find(".fix-top-left")
              .css("width", leftTotalWidth + 1 + "px");
            _this.$fixedHeaderBox
              .find(".fix-top-right")
              .css("width", rightTotalWidth + scrollWidth + 2 + "px");
              ...
              $(this)
                ...
                .each(function(thIndex) {
                  ...
                  if (thItemIndex === 0 && startIndex < thLength) {
                    rowspanByFistRow +=
                      parseInt($(this).attr("rowspan"), 10) - 1 ? 1 : 0;
                  }

                  if (startIndex < thLength) {
                    _this.$fixedHeaderBox
                      .find(".fix-top-left table, > table")
                      .each(function() {
                        $(this)
                          .find("tr")
                          .eq(thItemIndex)
            ...
            _this.$fixedColBox.css(
              "top",
              _this.$fixedHeaderBox.height() + "px"
            );
          }, 200);
        },
