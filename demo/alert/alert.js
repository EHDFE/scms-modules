export default {
  ...
  buttons: [
    ...
    },
    {
      value: '确认提示',
      callback:
        "$.alert('是否确认删除此记录？', {type:'confirm', callback:function() {console.log('执行：确认提示回调函数')}});",
    },
    {
      value: '确认提示有title,有回调函数，同时自动关闭弹出框',
      callback:
        "$.alert('是否确认删除此记录？', {type:'confirm', title:'确认提示',callback:function() {console.log('执行：确认提示回调函数')}});",
    },
    {
